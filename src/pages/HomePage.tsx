...
export function HomePage() {
  ...
  const activeDestination = homeDestinations.find((item) => item.id === activeId) ?? homeDestinations[0]

  return (
    <main>
      <div className="home-explorer page-width">
        <HebeiMap destinations={homeDestinations} activeId={activeId} onSelect={setActiveId} />
